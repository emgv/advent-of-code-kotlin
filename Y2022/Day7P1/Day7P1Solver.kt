...
class Day7P1Solver(val args: Array<String>) : ISolver {
    ...
    override fun run() {
        ...
        println(getDirsAtMost(rootNode, 100000u).sumOf { node -> node.TotalSize })
    }
    ...
    private fun getDirsAtMost(startNode:Node, MaxSize:UInt): List<Node> {
